...
### Viewer Único: Swagger UI (8081)

**Acesso:**
- Swagger UI (interactive testing): http://localhost:8081

**Quando atualizar specs OpenAPI:**
- Edite `application/docs/openapi/*.yaml`
- Hard refresh browser para limpar cache: `Ctrl+Shift+R` (Windows/Linux) ou `Cmd+Shift+R` (Mac)
- Ou restart Docker: `docker-compose -f application/docs/openapi-viewers/docker-compose.yml restart`

**Todos os specs compartilham a mesma pasta:** `application/docs/openapi/`
